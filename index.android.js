  ...
  render(){
      ...
      return <View key={index} style={styles.card}>
        <View style={styles.leftIcon}>
          <View style={{width: avatarSize, height: avatarSize, borderRadius: avatarSize/2}}>
            <Image source={{uri: item.user.avatar_url }} style={[styles.avatarImage, {borderRadius: avatarSize/2, width: 0.6*avatarSize, height: 0.6*avatarSize}]}/>
          </View>
        </View>
    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView onScroll={this.handleScroll.bind(this)} scrollEventThrottle={24}>
          {topics}
        </ScrollView>
        <Sidebar/>
      </View>
